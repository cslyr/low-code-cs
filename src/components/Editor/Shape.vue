    ...
    methods: {
        ...
        handleRotate(e) {
            ...
            const move = (moveEvent) => {
                ...
                // 获取旋转的角度值
                // console.log("两个角度是否相同",rotateDegreeAfter)
        ...
        handleMouseDownOnShape(e) {
            ...
            console.log("getBoundingClientRect",$(`#component${this.element.id}`).getBoundingClientRect())
            // getBoundingClientRect $(`#component${item.id}`).getBoundingClientRect()
        ...
        handleMouseDownOnPoint(point, e) {
            ...
            const move = (moveEvent) => {
                ...
                /*
                    其中point表示的是触发的是哪个点
                    style表示的是默认的样式
                    curPositon表示的是移动后的点的绝对定位
                    proportion指的是宽高比
                    symmetricPoint指的是对称坐标   还是移动之前算出来的
                */
